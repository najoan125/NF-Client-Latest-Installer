...
!define PRODUCT_NAME "NF Client (Fabric) 1.20"
...
Section "MainSection" SEC01
  ...
  iffileexists "$APPDATA\.nfclient-latest\versions\fabric-loader-0.14.21-1.20\fabric-loader-0.14.21-1.20.jar" O X
X:
