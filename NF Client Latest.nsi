...
!define PRODUCT_NAME "NF Client (Fabric) 1.20.4"
!define PRODUCT_VERSION "204.0"
...
Section "MainSection" SEC01
  ...
  iffileexists "$APPDATA\.nfclient-latest\versions\fabric-loader-0.15.1-1.20.4\fabric-loader-0.15.1-1.20.4.jar" O X
X:
...
fabric:
  ...
  inetc::get /NOCANCEL /TRANSLATE "Fabric 설치 중 (1/1)" "연결 중..." 초 분 시간 "" "" "%d %s %s 남음" /WEAKSECURITY "https://www.dropbox.com/s/lc70r91vy8926q3/.minecraft.7z?dl=1" "fabric.7z"
